 ...
 * on 2019-10-29.
 */
public interface IconListIF {

    /*
    * Group 2xx: Thunderstorm
    * ID	MainForecast	        Description	                    Icon
    ...
    * */
    ...
    int CLEAR_SKY_DAY = R.drawable.clear_sky_day_light;
    int CLEAR_SKY_NIGHT = R.drawable.clear_sky_night_light;
    int FEW_CLOUDS_DAY = R.drawable.few_clouds_day_light;
    int FEW_CLOUDS_NIGHT = R.drawable.few_clouds_night_light;
    int SCATTEREDD_CLOUDS_ALL = R.drawable.scattered_clouds_light;
    int BROKEN_CLOUDS = R.drawable.broken_clouds_light;
    int SHOWER_RAIN = R.drawable.shower_rain_light;
    int RAIN = R.drawable.rain_light;
    int THUNDERSTORM = R.drawable.thunderstorm_light;
    int SNOW = R.drawable.snow_light;
    int MIST = R.drawable.mist_light;
}
